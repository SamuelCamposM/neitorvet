...
class VentaForm extends Venta {
  ...
  VentaForm({
    ...
    super.venRucCliente = '',
    super.venProductos = const [],
    super.venId = 0,
    super.venCostoProduccion = 0,
    super.venDescuento = 0,
    super.venSubTotal = 0,
    super.venSubtotal0 = 0,
    super.venSubTotal12 = 0,
    super.venTotal = 0,
    super.venTotalIva = 0,
    super.venIdCliente = 0,
    super.venEmpIva = 0,
    super.venCeluCliente = const [],
    super.venEmailCliente = const [],
    super.fechaSustentoFactura = '',
    super.venAbono = '',
    super.venAutorizacion = '',
    super.venDescPorcentaje = 0,
    super.venDias = '',
    super.venDirCliente = '',
    super.venEmpAgenteRetencion = '',
    super.venEmpComercial = '',
    super.venEmpContribuyenteEspecial = '',
    super.venEmpDireccion = '',
    super.venEmpEmail = '',
    super.venEmpLeyenda = '',
    super.venEmpNombre = '',
    super.venEmpObligado = '',
    super.venEmpRegimen = '',
    super.venEmpresa = '',
    super.venEmpRuc = '',
    super.venEmpTelefono = '',
    super.venEnvio = '',
    super.venErrorAutorizacion = '',
    super.venEstado = '',
    super.venFacturaCredito = '',
    super.venFechaAutorizacion = '',
    super.venFechaFactura = '',
    super.venFecReg = '',
    super.venFormaPago = '',
    super.venNomCliente = '',
    super.venNumero = '',
    super.venNumFactura = '',
    super.venNumFacturaAnterior = '',
    super.venObservacion = '',
    super.venOption = '',
    super.venOtros = '',
    super.venOtrosDetalles = '',
    super.venTelfCliente = '',
    super.venTipoDocuCliente = '',
    super.venTipoDocumento = '',
    super.venTotalRetencion = '',
    super.venUser = '',
  });
  ...
  VentaForm copyWith({
    ...
    String? venUser,
      ...
      VentaForm(
          venRucClienteInput: venRucClienteInput ?? this.venRucClienteInput,
          venProductosInput: venProductosInput ?? this.venProductosInput,
